...
function ReportDecision() {
  ...
  const decisionOptions = [
    {
      ...
      description:
        "La procédure est complète et la décision finale est prise. Le dossier sera clôturé.",
      color: "#10b981",
      icon: "✅",
    },
    {
      ...
      label: "Escalader",
      description:
        "L'incident nécessite une intervention de niveau supérieur (Bureau National, autorités...).",
      color: "#f59e0b",
      icon: "⬆️",
    },
    {
      ...
      description:
        "La situation est résolue ou ne nécessite plus d'action. Le dossier sera archivé.",
      color: "#6b7280",
      icon: "📁",
    },
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      !confirm(
        "Êtes-vous sûr de vouloir prendre cette décision ? Cette action est définitive.",
      )
    ) {
      return;
    }
    ...
    return (
      <div className="report-decision-container">
        ...
        <div className="already-decided">
          <span className="icon">
            <SOSIcons.CheckCircle size={64} color="#00abec" />
          </span>
          <h2>Décision déjà prise</h2>
          <p>Ce signalement a déjà été traité et clôturé.</p>
          <div className="decision-info">
            <p>
              <strong>Décision :</strong> {report.decision.type}
            </p>
            <p>
              <strong>Date :</strong> {formatDate(report.decision.madeAt)}
            </p>
            {report.decision.details && (
              <p>
                <strong>Détails :</strong> {report.decision.details}
              </p>
            )}
          </div>
          <button
  ...
  return (
    <div className="report-decision-container">
      ...
      <form onSubmit={handleSubmit} className="decision-form">
        <h3 style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
          <SOSIcons.Scales size={20} color="#00abec" />
          Décision finale
        </h3>
        ...
        <div className="warning-box">
          ...
          <p>
            <strong>Attention :</strong> Cette action est définitive. Une fois
            la décision prise, le signalement sera clôturé et archivé.
            Assurez-vous d'avoir toutes les informations nécessaires avant de
            confirmer.
          </p>
        </div>
