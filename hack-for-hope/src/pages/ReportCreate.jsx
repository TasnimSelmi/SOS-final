      ...
      <form onSubmit={handleSubmit} className="report-form">
        ...
        <div className="form-section privacy-section">
          <label className="checkbox-label">
            ...
            <span className="label-text">
              ...
              <small>
                Votre identité ne sera pas visible par les autres utilisateurs
              </small>
            </span>
          </label>
        </div>
        ...
        <div className="form-section">
          ...
          <div className="attachments-section">
            ...
            >
              <SOSIcons.Paperclip size={18} /> Ajouter des fichiers
            </button>
                  ...
                  <div key={index} className="attachment-item">
                    <span className="file-icon">
                      {file.type.startsWith("image/") ? (
                        <SOSIcons.Image size={24} color="#00abec" />
                      ) : file.type.startsWith("audio/") ? (
                        <SOSIcons.Audio size={24} color="#00abec" />
                      ) : file.type.startsWith("video/") ? (
                        <SOSIcons.Video size={24} color="#00abec" />
                      ) : (
                        <SOSIcons.File size={24} color="#00abec" />
                      )}
                    </span>
